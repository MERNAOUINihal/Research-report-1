...
This research question focuses on material deprivation as a central constraint faced by urban households and treats informal social networks as adaptive mechanisms through which households cope. In fact, it tackles the topic from an individudal and bottom-up approach, in contrast to the literature that focuses on material deprivation from an economic, developmental, or policy standpoint. The issue about these kinds of approaches is that they ignore the ground-rooted realitities of people who suffer from material deprivation, forgetting to check the ways in which they adapt to their environments. If the literature focuses on this instead, we would be able to design more fitted policies, that do not disrupt the lives of these populations.

This can be illustrated by the case of informal settlements (slums/bidonvilles) in Morocco. Because the country has been suffering from slums that disrupt not only the cities' landscapes but also the country's development index, most policies offer substitutes to these populations, such as state-offered residencies. It is, however, important to not that in most cases, the ones residing in slums would not leave their residencies, regardless of the proposed offers, unless there is a coercive and physically present authority that pushes them to do so. This shows that they have reasons to choose to live and stay in their settlements, despite facing material deprivation. And besides the fact that these substitutes are often not precisely accommodating to the majority of families in question, by making them leave their housings, these policies also makes them loose the benefits they acquire from living there, such as their reliance on informal networks. Therefore, more generally speaking, if policies take into account the individual choices, rationales, and motives of people experiencing material deprivation, there would be better solutions to numerous issues, like the one discussed.
...
Figure 2: summarizes the conceptual framework underlying the research question and the two hypotheses examined in this study.
